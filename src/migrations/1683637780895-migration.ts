...
export class Migration1683637780895 implements MigrationInterface {
    name = 'Migration1683637780895'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comentario" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "comentario" character varying NOT NULL, "editado" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "announcementsId" uuid, CONSTRAINT "PK_c9014211e5fbf491b9e3543bb19" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "comentario" ADD CONSTRAINT "FK_27a52e0cd57d5571f00d229cfc3" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "comentario" ADD CONSTRAINT "FK_5f440076dc990090a205eb46ca8" FOREIGN KEY ("announcementsId") REFERENCES "anuncio"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "comentario" DROP CONSTRAINT "FK_5f440076dc990090a205eb46ca8"`);
